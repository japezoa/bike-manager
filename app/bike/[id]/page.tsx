    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex items-center justify-between mb-8">
          <Link href="/">
            <button className="flex items-center gap-2 bg-zinc-800 hover:bg-zinc-700 text-zinc-100 font-semibold py-3 px-6 rounded-lg transition-all duration-200">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Title */}
            <div className="card">
              <h1 className="text-4xl font-display font-black text-gradient mb-2">
                {bike.name}
              </h1>
              <p className="text-xl text-zinc-400 font-semibold">{bike.model}</p>
              <div className="flex flex-wrap gap-2 mt-4">
                <span className="px-4 py-2 bg-cyan-500/10 text-cyan-400 text-sm font-bold rounded-lg border border-cyan-500/20">
                  {bike.wheels.wheelSize}
                </span>
                <span className="px-4 py-2 bg-orange-500/10 text-orange-400 text-sm font-bold rounded-lg border border-orange-500/20">
            ...
            <div className="card">
              ...
              <div className="space-y-3">
                ...
                <div>
                  <span className="text-zinc-500 text-sm font-semibold">Geometría</span>
                  <p className="text-zinc-200">{bike.geometry}</p>
                </div>
                <div>
            ...
            <div className="card">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-display font-bold text-cyan-400">COMPONENTES</h3>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
